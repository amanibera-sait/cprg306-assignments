    ...
    return (
        ...
        {user && (
            <div>
                ...
                <Link href={"./week-10/shopping-list"}><button className="rounded-3xl bg-gray-400 font-bold text-gray-900 p-3 hover:bg-gray-500 hover:text-gray-100 active:bg-gray-200">Open Shopping List</button></Link>
            </div>
        )}
        </div>
    )
